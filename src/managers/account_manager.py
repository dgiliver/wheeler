...
class AccountManager:
    def __init__(self, total_balance: Decimal, max_position_size: float = 0.2, 
                 pdt_config: Optional[PDTConfig] = None):
    ...
    def update_pdt_status(self, equity: Decimal, daytrade_count: int, 
                          is_pattern_day_trader: bool) -> None:
    ...
    def get_max_contracts(self, strike_price: Decimal, existing_symbol: str = None, 
                          position_size_override: float = None) -> int:
